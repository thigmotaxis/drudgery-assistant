...
const obj = storage.taskFactory("12/19/22", "Birthday Party", "normal", "Make Abe feel uncomfortable by giving him a lot of attention");
storage.storeTask(obj)
const obj2 = storage.taskFactory("10/12/22", "Birthday Party", "normal", "Say HBD to Alex");
